    ...
    public static IServiceCollection AddSwaggerGenConfiguration(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("BonAppetitOpenApi",
                new OpenApiInfo()
                {
                    Title = "Bon Appetit Registration Service API",
                    Version = "V1.0",
                    Description = @"Bon Appetit microservices <br/> 
                                   <a href='https://localhost:44355/'>Bon Appetit manager App</a> <br/>
                                   <a href='https://localhost:44343/'>Bon Appetit client App</a> <br/>
                                   <a href='https://localhost:44376/swagger/index.html'>Registration Service</a> <br/>
                                   <a href='https://localhost:44310/swagger/index.html'>Restaurant Service</a> <br/>
                                   <a href='https://localhost:44360/swagger/index.html'>Table Service</a> <br/> 
                                   ...
                                   <a href='https://localhost:44360/swagger/index.html'>Coupon Service</a> <br/> "
                    ,
