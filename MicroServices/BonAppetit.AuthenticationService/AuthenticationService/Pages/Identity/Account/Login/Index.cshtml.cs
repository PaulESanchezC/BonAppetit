...
namespace AuthenticationService.Pages.Identity.Account.Login;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnGet(string returnUrl)
    {
        ...
        var user = await _userManager.FindByEmailAsync("TestRestaurant@email.com");
        await _userManager.AddPasswordAsync(user, "19178199Pa.");
