...
namespace Data.Migrations
{
    ...
    [Migration("20220330074229_Updated_Models-01")]
    partial class Updated_Models01
    {
            ...
            modelBuilder.Entity("Models.ImageModels.ImageBase", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 3, 30, 3, 42, 29, 608, DateTimeKind.Local).AddTicks(6409));
            ...
            modelBuilder.Entity("Models.MenuModels.MenuBase", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 3, 30, 3, 42, 29, 610, DateTimeKind.Local).AddTicks(1724));
            ...
            modelBuilder.Entity("Models.MenuModels.MenuItemsBase", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 3, 30, 3, 42, 29, 610, DateTimeKind.Local).AddTicks(6797));
            ...
            modelBuilder.Entity("Models.RestaurantModels.RestaurantBase", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 3, 30, 3, 42, 29, 612, DateTimeKind.Local).AddTicks(5676));
            ...
            modelBuilder.Entity("Models.ScheduleModels.ScheduleBase", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 3, 30, 3, 42, 29, 613, DateTimeKind.Local).AddTicks(4077));
